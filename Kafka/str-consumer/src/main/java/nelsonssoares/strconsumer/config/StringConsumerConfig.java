package nelsonssoares.strconsumer.config;
...
public class StringConsumerConfig {
   ...
   @Bean
    ...
    /*
      Interceptador de mensagens, que verifica se a mensagem contém a palavra "Testing",
      antes de ser consumida.
      Filtro ou validador de dados.
     */
    @Bean
    ...
    private RecordInterceptor<String, String> validMessage() {
        return (record,consumer) -> {
            if (record.value().contains("Testing")) {
                log.info("Mensagem interceptada, Palavra Testing detectada!");
                return record;
            }
            return record;
        };
